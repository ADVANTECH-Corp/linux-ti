...
struct dfs_pulse dfs_fcc_radars[] = {
    ...
    {18,  1,  700, 700, 0,  6,  5,  0,  1, 16,  0, 3,  1, 0},
    {18,  1,  350, 350, 0,  6,  5,  0,  1, 16,  0, 3,  0, 0},

    // FCC TYPE 6
    // {9,   1, 3003, 3003, 1,  7,  5,  0,  1, 18,  0, 0,  1}, // 333 +/- 7 us
    {9,   1, 3003, 3003, 1,  7,  5,  0,  1, 16,  0, 0,  1, 1},

    // FCC TYPE 2
    {23, 5, 4347, 6666, 0, 18, 8,  0,  7, 20,  0, 3,  0, 2},

    // FCC TYPE 3
    {18, 10, 2000, 5000, 0, 23,  6,  6, 13, 18,  0, 3, 0, 5},

    // FCC TYPE 4
    {16, 15, 2000, 5000, 0, 25,  5, 11, 23, 18,  0, 3, 0, 11},

    /*
     * FCC NEW TYPE 1
     * 518us to 938us pulses (min 56 pulses)
     */
    {57, 1, 1066, 1930, 0, 6, 20,  0,  1, 20,  0, 3,  0, 21},

    /*
     * FCC NEW TYPE 1
     * 938us to 2000 pulses (min 26 pulses)
     */
    {27, 1,  500, 1066, 0, 6, 13,  0,  1, 20,  0, 3,  0, 22},

    /*
     * FCC NEW TYPE 1
     * 2000 to 3067us pulses (min 17 pulses)
     */
    {18, 1,  325,  500, 0, 6,  9,  0,  1, 20,  0, 3,  0, 23},
...
//    {18,  5,  260,  260, 1, 10,  6,  1,  6, 18,  0, 3, 19}, // 3846 +/- 7 us
    {18,  1,  720,  720, 0,  6,  6,  0,  1, 16,  0, 3, 0, 17}, // 1389 +/- 6 us
    {18,  4,  250,  250, 0, 10,  5,  1,  6, 16,  0, 3, 0, 18}, // 4000 +/- 6 us
    {18,  5,  260,  260, 0, 10,  6,  1,  6, 16,  0, 3, 1, 19}, // 3846 +/- 7 us
...
struct dfs_pulse dfs_etsi_radars[] = {
    ...
    {30,  2,  300,  400, 2, 30,  3,  0,  5, 13, 0,   0, 1, 31},   /* Type 5*/
    /* 0.8-2us, 2-3 bursts, 400-1200 PRF, 15 pulses each */
    {30,  2,  400, 1200, 2, 30,  7,  0,  5, 13, 0,   0, 0, 32},   /* Type 6 */

    /* constant PRF based */
    /* 0.8-5us, 200  300 PRF, 10 pulses */
    {10, 5,   200,  400, 0, 24,  5,  0,  8, 13, 0,   0, 2, 33},   /* Type 1 */
    {10, 5,   400,  600, 0, 24,  5,  0,  8, 13, 0,   0, 2, 37},   /* Type 1 */
    {10, 5,   600,  800, 0, 24,  5,  0,  8, 13, 0,   0, 2, 38},   /* Type 1 */
    {10, 5,   800, 1000, 0, 24,  5,  0,  8, 13, 0,   0, 2, 39},   /* Type 1 */
//  {10, 5,   200, 1000, 0, 24,  5,  0,  8, 15, 0,   0, 2, 33},

    /* 0.8-15us, 200-1600 PRF, 15 pulses */
    {15, 15,  200, 1600, 0, 24, 8,  0, 18, 20, 0,   0, 0, 34},    /* Type 2 */

    /* 0.8-15us, 2300-4000 PRF, 25 pulses*/
    {25, 15, 2300, 4000,  0, 24, 10, 0, 18, 20, 0,   0, 0, 35},   /* Type 3 */

    /* 20-30us, 2000-4000 PRF, 20 pulses*/
    {20, 30, 2000, 4000, 0, 24, 6, 19, 33, 20, 0,   0, 0, 36},    /* Type 4 */
};
