 ...
 *
 */
typedef struct wnm_ps_bss_max_idle_cfg {
    /** Action: Get/Set */
	t_u16 bss_max_idle_action;
    /** Enable/Disable */
	t_u8 bss_max_idle_enable;
} __ATTRIB_PACK__ wnm_ps_bss_max_idle_cfg_t;
 ...
 *
 */
typedef struct wnm_ps_bss_max_idle_tlv {
    /** Header */
	MrvlIEtypesHeader_t header;
    /** BSSMaxIdle configuration */
	wnm_ps_bss_max_idle_cfg_t bss_max_idle_cfg;
} __ATTRIB_PACK__ wnm_ps_bss_max_idle_tlv_t;

/**
 *  Enum for DMS request type
 */
typedef enum {
	DMS_REQUEST_TYPE_ADD = 0,
	DMS_REQUEST_TYPE_REMOVE = 1,
	DMS_REQUEST_TYPE_CHANGE = 2
} __ATTRIB_PACK__ dms_request_type_e;
 ...
 *
 */
typedef struct wnm_ps_dms_cfg {
    /** Action: Get/Set */
	t_u16 dms_action;
    /** Enable/Disable */
	t_u8 dms_enable;
} __ATTRIB_PACK__ wnm_ps_dms_cfg_t;
...
typedef struct wnm_ps_dms_req {
	...
	t_u8 dms_desc_tlv[0];
} __ATTRIB_PACK__ wnm_ps_dms_req_t;
 ...
 *
 */
typedef struct wnm_ps_dms_tlv {
    /** Header */
	MrvlIEtypesHeader_t header;
    /** Configure DMS feature */
	wnm_ps_dms_cfg_t dms_cfg;
    /** Configure DMS request */
	wnm_ps_dms_req_t dms_req;
} __ATTRIB_PACK__ wnm_ps_dms_tlv_t;
