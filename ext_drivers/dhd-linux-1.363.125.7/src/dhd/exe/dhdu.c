 ...
 *
 * $Id: dhdu.c 603443 2015-12-02 05:25:13Z $
 */
...
static cmd_func_t dhd_logstamp, dhd_pmac, dhd_dump_mac;
#ifdef BCMSPI
...
cmd_t dhd_cmds[] = {
	...
	"get/set wireless ethernet feature" },
...
static dbg_msg_t dhd_msgs[] = {
	...
	{DHD_WL_VAL, "wl"},
	{DHD_NOCHECKDIED_VAL, "nochkdied"},
	{DHD_WL_VAL2, "wl2"},
	{DHD_PNO_VAL, "pno"},
	{DHD_RTT_VAL, "rtt"},
	{DHD_MSGTRACE_VAL, "msgtrace"},
	{DHD_FWLOG_VAL, "firmwareLog"},
	{DHD_DBGIF_VAL, "dbgif"},
	{DHD_DBG_BCNRX_VAL, "bcnrx"},
	{0,		NULL}
};
