 ...
 */
char firmware_path[MOD_PARAM_PATHLEN] = "/lib/firmware/brcm/brcmfmac43241b4-sdio.bin";
char nvram_path[MOD_PARAM_PATHLEN] = "/lib/firmware/brcm/brcmfmac43241b4-sdio.txt";
